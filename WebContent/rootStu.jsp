...
<script type="text/javascript">
	...
	function openStudentAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加服务员信息");
		url="studentSave";
	}
	...
	function openStudentModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑服务员信息");
		$("#fm").form("load",row);
	...
	<div id="tb">
		<div>
			<a href="javascript:openStudentAddDialog()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">员工扩招</a> <a
				href="javascript:openStudentModifyDialog()"
				class="easyui-linkbutton" iconCls="icon-edit" plain="true">员工信息更改</a> <a
				href="javascript:deleteStudent()" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true">员工离职</a>
		</div>
		<div>
