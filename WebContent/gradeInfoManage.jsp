...
<body style="margin: 5px;">
	<table id="dg" title="职务信息" class="easyui-datagrid" fitColumns="true"
		...
		<thead>
			<tr>
				...
				<th field="gradeName" width="100">职务名称</th>
				<th field="gradeDesc" width="250">职务描述</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:openGradeAddDialog()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">新增职务</a> <a
				href="javascript:openGradeModifyDialog()" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true">职务更名</a> <a
				href="javascript:deleteGrade()" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true">裁减职务</a>
		</div>
		<div>
			&nbsp;职务名称：&nbsp;<input type="text" name="s_gradeName"
