...
<script type="text/javascript">
	...
	function deleteGrade(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("roomDelete",{delIds:ids},function(result){
					if(result.success){
	...
	function openGradeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑房间信息");
		$("#fm").form("load",row);
	...
	<div id="tb">
		<div>
			<a href="javascript:openGradeAddDialog()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">添加房间</a> <a
				href="javascript:openGradeModifyDialog()" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true">房间信息更改</a> <a
				href="javascript:deleteGrade()" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true">房间停用</a>
		</div>
		<div>
