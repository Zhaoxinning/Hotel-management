...
<body>
	<img id="bg_img" src="./images/bg_img.jpg" alt="background-img"
			...
			<div class="row no-gutters justify-content-center" id="focus_body">
				<div class="col-12 col-sm p-md-1 py-lg-3 px-lg-5">
					...
					<div class="card-body focus_div">
						...
						<form class="needs-validation" action="logon" method="post">
							...
							<div>
								<h8 class="card-title">跳转至服务员登录<a href="index.jsp">服务员登录</a>
								</h2>
							</div> 
