...
<script type="text/javascript">
	function deleteStudent(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("orderDelete",{delIds:ids},function(result){
					if(result.success){
	...
	function openStudentModifyDialog(){
		...
		$("#fm").form("load",row);
		url="orderSave?stuId="+row.stuId;
	}
</script>
</head>
<body style="margin: 5px;">
	<table id="dg" title="订单信息" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="orderList" fit="true"
		toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="stuId" width="50" align="center">编号</th>
				<th field="stuNo" width="100" align="center">订单号</th>
				<th field="stuName" width="100" align="center">姓名</th>
				<th field="sex" width="100" align="center">性别</th>
				<th field="birthday" width="100" align="center">入住日期</th>
				<th field="gradeId" width="100" align="center" hidden="true">房间编号</th>
				<th field="gradeName" width="100" align="center">房间名</th>
				<th field="email" width="150" align="center">邮箱</th>
				<th field="stuDesc" width="250" align="center">备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			<a href="javascript:openStudentAddDialog()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">办理入住</a> <a
				href="javascript:openStudentModifyDialog()"
				class="easyui-linkbutton" iconCls="icon-edit" plain="true">订单修改</a> <a
				href="javascript:deleteStudent()" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true">删除订单</a>
		</div>
		<div>
			&nbsp;订单号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo" size="10" /> 
			...
			&nbsp;日期：&nbsp;<input class="easyui-datebox" name="s_bbirthday"id="s_bbirthday" editable="false" size="10" />-><input 
			...
			&nbsp;房间号：&nbsp;<input
				...
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'roomComboList'" />
			...
			<table cellspacing="5px;">
				...
				<tr>
					...
					<td><input class="easyui-combobox" id="gradeId" name="gradeId"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'roomComboList'" /></td>
					<td></td>
					<td>Email：</td>
					<td><input type="text" name="email" id="email"
						class="easyui-validatebox" required="false" validType="email" /></td>
				</tr>
				<tr>
					<td valign="top">备注：</td>
